...
///
/// All other tunables match ParticleDemo so this scene is a side-by-side
/// visual check that the shape change is the only thing different.
class LineParticleDemo: DefaultScene {
    ...
    private let neonStartColor = Vec4(1.0, 0.30, 0.75, 0.7)
    private let neonStartVar   = Vec4(0.75, 0.30, 1.0, 0.7)
